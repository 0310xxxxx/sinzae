...
import { faUser, faKey, faCalendarDays, faVenusMars, faHomeUser, faMobileScreenButton, faSignature } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className='signUpContainer'>
            <form onSubmit={handleSubmit}>
                ...
                <div className='inputGroup'>
                    <label htmlFor="user_birthdate" className='labelContainer1'>
                ...
                <div className='inputGroup'>
                    <label htmlFor="user_gender" className='labelContainer2'>
